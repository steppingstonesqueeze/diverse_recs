...
def demo():
    ...
    for method in ["pca", "tsne", "umap"]:
        ...
        plot_embedding(Y, selected_idxs=greedy_idx, title=f"Greedy-50 ({method.upper()})", save_path=f"embeds/greedy50_{method}.png")
        plot_embedding(Y, selected_idxs=dpp_idx, title=f"k-DPP-50 ({method.upper()})", save_path=f"embeds/kdpp50_{method}.png")
